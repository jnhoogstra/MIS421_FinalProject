...
namespace MIS421_FinalProject.Views.Home
{
    public class DocumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("docID,docName,uploadDate,verified,content")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("docID,docName,uploadDate,verified,content")] Document document)
        {
